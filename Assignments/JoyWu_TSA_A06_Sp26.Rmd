...
> Answer: For AR (2), the most important characteristics of the ACF plot are that it tails off gradually to zero with a slow decay. For PACF, the plot shows that there's a cut off after lag 2, with significant spikes at lag 1 and 2 since this is an autoregressive model of order 2.  

* MA(1)

> Answer: For MA (1), the most important characteristics of the ACF plot are that it shows a spike at lag 1 and cuts off after that since MA has an order of 1 here. For PACF, the plot shows that the decay is gradual and doesn't cut off sharply.

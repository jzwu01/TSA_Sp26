...
HP1_acf= acf(ts_inflow_data[,1],lag.max = 60,plot = TRUE) #any points (lags) that fall within the two dashed lines show that they are not significant enough to be counted
...
HP1_acf= Acf(ts_inflow_data[,4],lag.max = 60) #acf lets us make a better prediction of whether there is seasonality/trend rather than just make assumptions based on looking at ts plots
